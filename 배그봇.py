...
async def on_message(message):
    ...
    if message.content.startswith('!맵 미라마'):
        embed = discord.Embed()
        embed.set_image(url="https://guide.pubg.com/img/map_miramar_img01.7da8c735.jpg")
    ...
    if message.content.startswith('!맵 에란겔'):
        embed = discord.Embed()
        embed.set_image(url="https://guide.pubg.com/img/map_erangel_img01.f1608633.jpg")
    ...
    if message.content.startswith('!맵 사녹'):
        embed = discord.Embed()
        embed.set_image(url="https://guide.pubg.com/img/map_sanhok_img01.cdd5b70d.jpg")
    ...
    if message.content.startswith('!맵 비켄디'):
        embed = discord.Embed()
        embed.set_image(url="https://guide.pubg.com/img/map_vikendi_img01.6bf31c6e.jpg")
